...
/* These constants are gotten from both EFI-1.10 and UEFI-2.3.1 specs */
...
#define EFI_DEVICE_PATH_TYPE_HARDWARE_END 0x7F
#define EFI_DEVICE_PATH_TYPE_END 0xFF

#define EFI_DEVICE_PATH_TYPE_HARDWARE_SUBTYPE_PCI 0x01
#define EFI_DEVICE_PATH_TYPE_HARDWARE_SUBTYPE_PCCARD 0x02
#define EFI_DEVICE_PATH_TYPE_HARDWARE_SUBTYPE_MEMORY_MAPPED 0x03
#define EFI_DEVICE_PATH_TYPE_HARDWARE_SUBTYPE_VENDOR 0x04
#define EFI_DEVICE_PATH_TYPE_HARDWARE_SUBTYPE_CONTROLLER 0x05

#define EFI_DEVICE_PATH_TYPE_ACPI_SUBTYPE_ACPI 0x01
#define EFI_DEVICE_PATH_TYPE_ACPI_SUBTYPE_EXPANDED_ACPI 0x02
#define EFI_DEVICE_PATH_TYPE_ACPI_SUBTYPE_ADR 0x03 /* UEFI only */

#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_ATAPI 1
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_SCSI 2
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_FIBRE_CHANNEL 3
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_FIBRE_CHANNEL_EX 21 /* UEFI only */
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_1394 4
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_FIREWIRE 4
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_SATA 18 /* UEFI only */
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_USB 5
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_USB_WWID 16 /* UEFI only */
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_USB_CLASS 15
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_I2O 6
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_MAC 11
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_IPV4 12
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_IPV6 13
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_VLAN 20 /* UEFI only */
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_INFINIBAND 9
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_UART 14
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_VENDOR 10
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_SAS_EX 22 /* UEFI only */
#define EFI_DEVICE_PATH_TYPE_MESSAGING_SUBTYPE_ISCSI 19 /* UEFI only */

#define EFI_DEVICE_PATH_TYPE_MEDIA_SUBTYPE_HARDDRIVE 1
#define EFI_DEVICE_PATH_TYPE_MEDIA_SUBTYPE_CDROM_ET 2 
#define EFI_DEVICE_PATH_TYPE_MEDIA_SUBTYPE_VENDOR 3
#define EFI_DEVICE_PATH_TYPE_MEDIA_SUBTYPE_FILE_PATH 4
#define EFI_DEVICE_PATH_TYPE_MEDIA_SUBTYPE_MEDIA_PROTOCOL 5
#define EFI_DEVICE_PATH_TYPE_MEDIA_SUBTYPE_PIWG_FW_FILE 6 /* UEFI only */
#define EFI_DEVICE_PATH_TYPE_MEDIA_SUBTYPE_PIWG_FW_VOLUME 7 /* UEFI only */
#define EFI_DEVICE_PATH_TYPE_MEDIA_SUBTYPE_REL_OFF_RANGE 8 /* UEFI only */

#define EFI_DEVICE_PATH_TYPE_BIOS_SUBTYPE_BIOS 1

#define EFI_DEVICE_PATH_TYPE_END_SUBTYPE_INSTANCE 0x01
#define EFI_DEVICE_PATH_TYPE_END_SUBTYPE_END 0xFF

#define acpi_dev_path(p) ((ACPI_DEVICE_PATH*)p)
typedef struct {
	uint8_t type;
	uint8_t subtype;
	uint16_t length;
...
#define vendor_dev_path(p) ((VENDOR_DEVICE_PATH*)p)
typedef struct {
	uint8_t type;
	uint8_t subtype;
	uint16_t length;
...
#define pci_dev_path(p) ((PCI_DEVICE_PATH*)p)
typedef struct {
	uint8_t type;
	uint8_t subtype;
	uint16_t length;
